...
перепада - фильтр имеет затухание 12 dB на октаву.
...
полосы пропускания и коэфициентом Q, отвечающим за ширину полосы пропускания.
...
частотой и силой фазового сдвига.
