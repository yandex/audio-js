...
<img src="images/bandpass-filter.png" width="100%" alt="Рис. 12. Графики АЧХ полосно-заграждающих фильтров" />
...
Данный фильтр отличается максимально гладкой функцией групповой задержки и линейной ФЧХ, за счёт чего форма выходного сигнала в полосе пропускания сохраняется практически неизменной. Данный фильтр относится к БИХ-фильтрам.
...
Отличительной особенностью данного фильтра является максимально гладкая функция АЧХ. Однако он имеет достаточно большую нелинейную групповую задержку в полосе пропускания на высоких порядках. Этот фильтр также относится к БИХ-фильтрам.

#### [Фильтр Чебышёва](https://ru.wikipedia.org/wiki/Фильтр_Чебышёва)

**ОПИСАТЬ ДАННЫЙ ФИЛЬТР**
...
#### [Фильтр Гаусса](https://ru.wikipedia.org/wiki/Фильтр_Гаусса)
