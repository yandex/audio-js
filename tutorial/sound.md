...
*Все графики отображают диапазон частот от 20Гц до 20000Гц, по обеим осям применяется логарифмический масштаб.
Горизонтальная ось отображает частоту, вертикальная - магнитуду (синий график) или фазовый сдвиг (зелёный график).
...
### Фильтр allpass
![фильтр allpass](images/allpass.gif)
