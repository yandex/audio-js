...
воспользоваться [данным интерактивным примером](https://www.desmos.com/calculator/aojmanpjrl). В левом меню можно
включать/выключать отображение графиков, настраивать параметры входных данных и параметры дискретизации, или можно
просто двигать контрольные точки.
